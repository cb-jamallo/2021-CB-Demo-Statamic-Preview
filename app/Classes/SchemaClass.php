...
class SchemaClass
{
    ...
    **/
    ...
    protected function replicateBuild() 
    {
        ...
        $l = shell_exec( $buildDirectoryUserPath . ' git push https://cb-jamallo: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@github.com/cb-jamallo/2021-CB-Demo-Statamic-Preview.git main 2>&1');
