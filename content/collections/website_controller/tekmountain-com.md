        ...
        content:
          code: |-
            <!-- <script context='module'>
                ...
                // Get all pages in dir from Vite : https://vitejs.dev/guide/features.html#glob-import
                // Could be useful when dynamically setting navigation order through a CMS system...
                //const hooks = import.meta.glob('/src/hooks/**.svelte');
