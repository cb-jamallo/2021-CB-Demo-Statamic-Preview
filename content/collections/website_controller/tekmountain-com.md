...
development-image:
  ...
  -
    ...
    file: tekmountain-com/image/global/tekmountain-logo-mark-color.svg
    type: item
    enabled: true
  -
    uid: tekmountain-logo-mark-reversed
    file: tekmountain-com/image/global/tekmountain-logo-mark-reversed.svg
    type: item
    enabled: true
  -
    uid: tekmountain-logo-horizontal-color
    file: tekmountain-com/image/global/tekmountain-logo-horizontal-color.svg
    type: item
    enabled: true
  -
    uid: tekmountain-logo-horizontal-reversed
    file: tekmountain-com/image/global/tekmountain-logo-horizontal-reversed.svg
    type: item
    enabled: true
  -
    uid: tekmountain-logo-vertical-color
    file: tekmountain-com/image/global/tekmountain-logo-vertical-color.svg
    type: item
    enabled: true
  -
    uid: tekmountain-logo-vertical-color
    file: tekmountain-com/image/global/tekmountain-logo-vertical-reversed.svg
    type: item
    enabled: true
  -
    uid: background-line-angle-white
    file: tekmountain-com/image/global/background-line-angle-white.png
    type: item
    enabled: true
